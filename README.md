# NE PAS DIFFUSER CETTE BRANCHE

`students-archive` est là pour ça. Pour avoir une archive à peu près propre :
```
git clone --branch students-archive --depth 1 [remote]
git submodule update --init --recursive --depth 1
```
Attention CMake s'attend à ce que le dossier soit un dépôt git.
