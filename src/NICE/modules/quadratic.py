...
def quadratic_spline(inputs,
    ...
    r""" Implementation of quadratic spline.
        ...
        Args:
            ...
            left (float32): Left edge of the valid spline region
            right (float32): Right edge of the valid spline region
            bottom (float32): Bottom edge of the valid spline region
            top (float32): Top edge of the valid spline region
            min_bin_width (float32): The minimum allowed width of a given bin
            min_bin_height (float32): The minimum allowed height of a given knot
    ...
    right = tf.cast(right, dtype=tf.float32)
    bottom = tf.cast(bottom, dtype=tf.float32)
    top = tf.cast(top, dtype=tf.float32)
